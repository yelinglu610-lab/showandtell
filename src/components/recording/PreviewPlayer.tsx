...
export function PreviewPlayer({ src, onClose, onExport, onDownload, onClip }: PreviewPlayerProps) {
    ...
    <div className="fixed inset-0 z-50 bg-black/80 flex items-center justify-center">
      <div className="bg-background rounded-lg shadow-xl max-w-4xl w-full mx-4 overflow-hidden">
        ...
        <div className="flex items-center justify-between px-4 py-3 border-t">
          <button
            onClick={onClip}
            className="px-4 py-2 text-sm border border-border hover:bg-muted rounded-md transition-colors flex items-center gap-2"
          >
            <span>✂️</span> 剪辑
          </button>
